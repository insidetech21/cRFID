...
class InPOSet {
  static Future<List<PosetItemSet>> fetchInPoSet(String poNo) async {
...
// Encode the username and password in Base64
    ...
    final url =
        "https://aincfapim.test.apimanagement.eu10.hana.ondemand.com/ZCIMS_INT_SRV/IN_POSet('$poNo')/Navg_Po";
